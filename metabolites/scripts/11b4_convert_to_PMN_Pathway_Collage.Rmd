...
ElasticNet0.5_LOO_prop_var <- read_csv(file.path("..","output","ElasticNet0.5_LOO_prop_var.csv"))
...
coregenes <-list()
temp <- modTrait.leaf_avg.RP2.cor.GSEA.summary %>% filter(FDR < 0.3 & `FDR q-val`< 0.3)
...
names(coregenes) <- temp$voom.module
