...
met_per_mg_lm_results %>% select(-term.trt, - term.leaf) %>% write_csv("../output/met_per_mg_lm_full.csv")
```
...
met_amt_lm_results %>% select(-term.trt, - term.leaf) %>% write_csv("../output/met_amt_lm_full.csv")
```
...
met_per_mg_lm_results %>% select(-term.trt, - term.leaf) %>% write_csv("../output/met_per_mg_lm_NOBLANK.csv")
...
met_amt_lm_results %>% select(-term.trt, - term.leaf) %>% write_csv("../output/met_amt_lm_NOBLANK.csv")
