...
p.root.trt.gt.e1 <- expression.pattern.Br.graph.exp1and3.v3.0annotation.voom(target.genes=target,title.e1="ex1 v3.0 voom",title.e3="exp3 v3.0 voom",tissue.type="root",FDR.e1=FDR.e1,FDR.e3="N/A",geno="both",exp="exp1and3") # confirming this DEGs is true for only root UN.
...
p.leaf.trt.gt.e1 <- expression.pattern.Br.graph.exp1and3.v3.0annotation.voom(target.genes=target,title.e1="ex1 v3.0 voom",title.e3="exp3 v3.0 voom",tissue.type="leaf",FDR.e1=FDR.e1,FDR.e3="N/A",geno="both",exp="exp1and3") # confirming this DEGs is true for only root UN.
