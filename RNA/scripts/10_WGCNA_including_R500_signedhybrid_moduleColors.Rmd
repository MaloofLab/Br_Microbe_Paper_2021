...
# making gmx file for GSEA with WGCNA modules -> WGCNA.signedhybrid.moduleColors.voom5.csv.gz (072021)
# no need to make because GSEA is not used any more.
```{r}
#WGCNA.modules2 
Br.v3.0anno.At.BLAST.highscore.moduleColors.signedhybrid <- read_csv(file.path("RNA","output","WGCNA.signedhybrid.moduleColors.voom5.csv.gz")) # change object name

Br.v3.0anno.At.BLAST.highscore.moduleColors.signedhybrid.list <- Br.v3.0anno.At.BLAST.highscore.moduleColors.signedhybrid %>% dplyr::select(name,contains("voom")) %>% 
...
making.gmx <- function(x,data.list=Br.v3.0anno.At.BLAST.highscore.moduleColors.signedhybrid.list) {
  load("n.Rdata")
  n <- n + 1
  print("n is")
  print(n)
...
n <- 0
save(n,file="n.Rdata")
Br.v3.0anno.At.BLAST.highscore.moduleColors.signedhybrid.list.gmx <- Br.v3.0anno.At.BLAST.highscore.moduleColors.signedhybrid.list %>% map(~making.gmx(.))
rm("n.Rdata") # not found... why?
...
for(x in names(Br.v3.0anno.At.BLAST.highscore.moduleColors.signedhybrid.list.gmx)) {
  write_tsv(Br.v3.0anno.At.BLAST.highscore.moduleColors.signedhybrid.list.gmx[[x]],file=file.path("annotation","output",str_c(x,".gmx",sep="")))
}
```
