...
# summary
cor.summary <- tibble(
  x = c(-0.7,-0.7,-0.7,-0.7), y=c(0.9,0.75,1.55,1.35),
...
library(cowplot)
#library(ggplotify) # https://github.com/ggobi/ggally/issues/256
p.all <- cowplot::plot_grid(root.exp1and3.FDR0.1.plot.s, leaf.exp1and3.FDR0.1.plot.s, venn.ggplot, labels = c('A','B','C'), label_size = 12,ncol=3,rel_widths=c(1,1,2),rel_heights = c(2,2,1))
p.all
ggsave2(p.all,filename=file.path("RNA","output","cor.plus.Venn.png"),width=11,height=8,units="in")
```
