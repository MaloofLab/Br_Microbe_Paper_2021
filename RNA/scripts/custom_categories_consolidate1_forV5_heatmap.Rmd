...
Total.forGSEA <- read_csv(file=file.path("annotation","output","Total.consolidated1.v5.csv"))
##
full.level.x <- tibble(category=colnames(Total.forGSEA))  %>% separate(category,into=c("category3","tissue3","FC","up_down"),sep="_") %>% 
