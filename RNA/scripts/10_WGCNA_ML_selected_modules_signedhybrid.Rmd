...
WGCNA.voom5.signedhybrid.all.modules.customcat.GOseq.plot.selected2 <- WGCNA.voom5.signedhybrid.all.modules.customcat.GOseq.plot.selected2 + theme(axis.text.x=element_text(size=8,angle=90,hjust=1),
...
ggsave(plot.GSEA,filename="GSEA.RNAseq.plot.ML.signedhybrid.selected.FDR0.3.png",path=file.path("RNA","output"),width=6,height=20) # needs to fix
...
<!-- # GOseq of all WGCNA modules (leaf.voom5.signedhybrid, root.voom5.signedhybrid version) with custom categories  (copied from "10_WGCNA_including_R500.Rmd") -->
...
<!-- # GOseq of all WGCNA modules (leaf.voom5.signedhybrid, root.voom5.signedhybrid version) with GO terms -->
<!-- ```{r} -->
<!-- #Br.v3.0anno.At.BLAST.highscore.modules2 <- read_csv(file.path("RNA","output","WGCNA.modules2.voom5.csv.gz")) -->
<!-- # stats of modules -->
<!-- Br.v3.0anno.At.BLAST.highscore.modules2 %>% group_by(root.voom5.module.signedhybrid) %>% summarise(root.voom5.module.signedhybrid.num=n()) %>% dim() # 41 2 -->
<!-- Br.v3.0anno.At.BLAST.highscore.modules2 %>% group_by(leaf.voom5.module.signedhybrid) %>% summarise(leaf.voom5.module.signedhybrid.num=n()) %>% dim() # 66 2 -->
<!-- GOseq.temp <- Br.v3.0anno.At.BLAST.highscore.modules2 %>% ungroup() %>% dplyr::select(name,root.voom5.module.signedhybrid,leaf.voom5.module.signedhybrid) %>% -->
