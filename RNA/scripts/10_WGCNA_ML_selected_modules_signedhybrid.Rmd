...
GSEA_reports.DF %>% mutate(NAME=NAME %>% str_remove_all(".VOOM5.SIGNEDHYBRID") %>% str_to_lower()) %>% inner_join(ElasticNet0.5_multiCV_Pct_var_signedhybrid,by=c("NAME"="tissue.module")) #%>% View()
# write csv
...
GSEA_reports.DF.plot.dendrogram.v10.WGCNAmodule.signedhybrid.notitle.ML(modules = "selected",dendrogram = "FALSE")
```
