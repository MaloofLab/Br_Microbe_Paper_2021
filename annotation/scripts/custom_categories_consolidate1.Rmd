...
save(GSEA_cust_rootshoot_updown4.consolidated.FDR0.001.list,file=file.path("annotation","output","GSEA_cust_rootshoot_updown4.consolidated.FDR0.001.list.Rdata"))
