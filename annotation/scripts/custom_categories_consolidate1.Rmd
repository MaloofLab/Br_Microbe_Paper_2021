...
# Overlap between "minusN_root_FC_down","plugMg_root_FC_down" in In02orLess (found in root.ivory)? (061521)
```{r}
...
In02orless.consolidated.forORA.list2 %>% enframe() %>% unnest(value) %>% filter(value %in% c("minusN_root_FC_down","plugMg_root_FC_down")) %>% count(name) %>% count(n,name="n of n") # no overlap
# 
load(file.path("annotation","output","In03orless.consolidated.forORA.list2.Rdata"))
In03orless.consolidated.forORA.list2 %>% enframe() %>% unnest(value) %>% filter(value %in% c("minusN_root_FC_down","plugMg_root_FC_down")) %>% count(name) %>% count(n,name="n of n") # no overlap
# 
load(file.path("annotation","output","In05orless.consolidated.forORA.list2.Rdata"))
In05orless.consolidated.forORA.list2 %>% enframe() %>% unnest(value) %>% filter(value %in% c("minusN_root_FC_down","plugMg_root_FC_down")) %>% count(name) %>% count(n,name="n of n") # no overlap
# 
load(file.path("annotation","output","In10orless.consolidated.forORA.list2.Rdata"))
In10orless.consolidated.forORA.list2 %>% enframe() %>% unnest(value) %>% filter(value %in% c("minusN_root_FC_down","plugMg_root_FC_down")) %>% count(name) %>% count(n,name="n of n") # no overlap
# 
load(file.path("annotation","output","In20orless.consolidated.forORA.list2.Rdata"))
In20orless.consolidated.forORA.list2 %>% enframe() %>% unnest(value) %>% filter(value %in% c("minusN_root_FC_down","plugMg_root_FC_down")) %>% count(name) %>% count(n,name="n of n") # no overlap
# 
load(file.path("annotation","output","Total.consolidated.forORA.list2.Rdata"))
In05orMore.consolidated.forORA.list2 %>% enframe() %>% unnest(value) %>% filter(value %in% c("minusN_root_FC_down","plugMg_root_FC_down")) %>% count(name) %>% count(n,name="n of n") # no overlap
#
