...
write_csv(all.data, file=file.path("annotation","output","root.all.comparison.v5.csv.gz")) 
```
...
#
write_csv(all.data, file=file.path("annotation","output","shoot.all.comparison.v5.csv.gz"))
```
