...
#
custom.categories.filename <- list.files(path=file.path("annotation","input","custom_categories"),pattern="(FC.csv.gz|FC.WT.csv.gz|DEGs.all.anno.csv.gz|DEGs.all.anno.csv|DEGs.csv.gz|Fe_def_KIM_2019_pnas.1916892116.sd01.csv)",full.names = FALSE)
...
write_csv(all.data, file=file.path("annotation","output","root.all.comparison.v4.csv.gz")) 
```
...
#
write_csv(all.data, file=file.path("annotation","output","shoot.all.comparison.v4.csv.gz"))
```
